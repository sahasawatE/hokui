...
export const fieldBorderStyles = tv({
  variants: {
    ...
    color: {
      default:
        "[--c:var(--hok-default-200)] [--borderColor:hsl(var(--c))] [--bgColorFlat:hsl(var(--c)/0.8)]",
      primary:
        "[--c:var(--hok-primary-100)] [--borderColor:hsl(var(--c))] [--bgColorFlat:hsl(var(--c)/0.8)]",
      secondary:
        "[--c:var(--hok-secondary-100)] [--borderColor:hsl(var(--c))] [--bgColorFlat:hsl(var(--c)/0.8)]",
      success:
        "[--c:var(--hok-success-300)] [--borderColor:hsl(var(--c))] [--bgColorFlat:hsl(var(--c)/0.8)]",
      danger:
        "[--c:var(--hok-danger-300)] [--borderColor:hsl(var(--c))] [--bgColorFlat:hsl(var(--c)/0.8)]",
      warning:
        "[--c:var(--hok-warning-300)] [--borderColor:hsl(var(--c))] [--bgColorFlat:hsl(var(--c)/0.8)]",
